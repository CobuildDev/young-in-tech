...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col bg-white text-zinc-900 dark:bg-black dark:text-zinc-50 font-sans selection:bg-purple-100 dark:selection:bg-purple-900/50">
      ...
      <section className="relative overflow-hidden px-6 pt-24 pb-32 md:pt-32 md:pb-40">
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center flex flex-col items-center">
          <Typography variant="h1" align="center" className="!text-5xl sm:!text-7xl md:!text-[5rem] !font-bold !tracking-tight !leading-[1.1] mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8B5CF6] via-[#D946EF] to-[#F97316]">Young In Tech.</span>
          </Typography>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Button as="a" href="/waitlist" variant="primary" size="lg" className="rounded-full h-14 px-8 text-base shadow-lg shadow-purple-500/20">
              Join the waitlist
      ...
      {/* Features Section */}
      <section id="features" className="py-24 bg-zinc-50 dark:bg-zinc-950/50 border-y border-zinc-100 dark:border-zinc-900">
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-4xl mx-auto bg-zinc-900 dark:bg-zinc-900 rounded-[2.5rem] p-10 md:p-16 text-center shadow-2xl relative overflow-hidden border border-zinc-800">
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-purple-500/20 via-pink-500/10 to-transparent blur-3xl rounded-full -translate-y-1/2 translate-x-1/3 pointer-events-none" />
